...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        String img_filename = "C:\\Users\\jens.baetens3\\OneDrive - ODISEE\\Lesmateriaal\\MachineLearning\\Lessen\\03_Computervisie\\07_Deployment\\img1.jpg";
    ...
    static DenseTensor<float> LoadImageAsTensor(string imagePath, int width, int height)
    {
        ...
        // hier niet geoptimaliseerd voor de nodige preprocessing stappen
